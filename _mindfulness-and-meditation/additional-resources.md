...
<ul class="onpage"><p class="onpage__header">on this page</p>
  ...
  <li><a href="#books-specifically-for-therapists">Books Specifically for Therapists</a></li>
  <li><a href="#audio">Audio</a></li>
  <li><a href="#book-plus-audio-disk-combinations">Book Plus Audio Disk Combinations</a></li>
  <li><a href="#scholarly-and-scientific-articles">Scholarly and Scientific Articles</a></li>
